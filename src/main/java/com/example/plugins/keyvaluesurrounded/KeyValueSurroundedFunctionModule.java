...
public class KeyValueSurroundedFunctionModule extends PluginModule {
    ...
    protected void configure() {
        addMessageProcessorFunction(KeyValueSurroundedFunction.NAME, KeyValueSurroundedFunction.class);
    }
